...
router.post('/', function(req, res) {
    ...
    pg.connect(connectionString, function(err, client, done) {
        ...
        client.query('INSERT INTO owners (first_name, last_name)' //properties from the database
            +
            'VALUES ($1, $2)', //the bling is a prepared statement
            [owner.firstName, owner.lastName], //properties on the object sent to server
            function(err, result) {
                done();
